...
FIG_PATH = join(FIG_PATH, 'Decoding', 'Single sessions', 'block')
...
decoding_result = pd.read_pickle(join(SAVE_PATH,
           ('decode_block_%s_%s_%s_neurons_%s_sessions.p' % (DECODER, CHANCE_LEVEL,
...
for i in range(N_SESSIONS):
    ...
    ax1.set(xticks=np.arange(7),
            xticklabels=['acc.', 'phase', 'pseudo', '', 'f1', 'phase', 'pseudo'],
